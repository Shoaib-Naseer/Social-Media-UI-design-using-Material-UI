...
import { Avatar, AvatarGroup, Divider, List,ListItem,ImageList, ImageListItem, ListItemAvatar, ListItemText, Typography } from '@mui/material'

const Rightbar = () => {
  return (
    <Box  flex={2} p={2} sx={{display:{xs:'none',sm:"block"}}}>
      <Box position="fixed">
        <Typography variant='h5' fontWeight={200}>Online Friends</Typography>
        <AvatarGroup max={5}>
        ...
        <Typography variant='h5' fontWeight={200} mt={2} mb={2}>Latest Posts</Typography>
        ...
        <Typography variant='h5' fontWeight={200} mt={2} mb={2}>Latest Conversations</Typography>
